...
import com.example.musicappandroid.R;
import com.example.musicappandroid.PlayMusic;
...
public class SongAdapter extends RecyclerView.Adapter<SongAdapter.SongViewHolder>{
    ...
    public SongViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.song_music,parent,false);
